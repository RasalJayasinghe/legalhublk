...
def fetch_latest_documents():
    ...
    try:
        ...
        print(f"Found {len(august_2025_docs)} documents from August 2025")
        ...
        # Create the latest data (August 2025 documents)
        latest_data = {
            "updated_at": datetime.utcnow().isoformat() + "Z", 
            "count": len(august_2025_docs),
            "documents": august_2025_docs
        }
        ...
        print(f"   - latest.json: {len(august_2025_docs)} documents from August 2025")
        
        if august_2025_docs:
            print(f"📅 Latest document date: {august_2025_docs[0]['date']}")
            print("🆕 Recent August documents:")
